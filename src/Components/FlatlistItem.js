...
// const Item=({heading,color1,color2,ratings,OriginalPrice,discountedPercentage,discountedPrice,TotalPrice,discountedPrice})=>{


//     return(
//         <View style={styles.parent}>
//             <View style={{marginVertical:w(1),marginBottom:h(5)}}>
//                 <Text>hii</Text>
//             </View>
